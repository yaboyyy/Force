...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['order'])) {
    ...
    if (!isset($_SESSION['loggedin']) || !isset($_SESSION['userid'])) {
        ...
        $product_id = 2; // ID for Nature model
...
<head>
  ...
  <title>FORCE BG | Force Nature</title>
...
<body>
  ...
  <main class="model-detail">
    <div class="model-image">
      <img src="../car2.jpg" alt="Nature 1">
    </div>
    
    <div class="model-info">
      <h1>Модел 2 - Force Nature</h1>
      <p>За първи път в нашата компания представяме първия наш електричен автомобил...</p>
      
      <div class="model-specs">
        <div class="spec-item">
          <span class="spec-name">Двигател:</span>
          <span class="spec-value">2.0L Turbo (600 к.с.)</span>
        </div>
        <div class="spec-item">
        ...
        <div class="spec-item">
          ...
          <span class="spec-value">2.5L/100km комбиниран</span>
        </div>
        <div class="spec-item">
      ...
      <div class="price">Цена: 70 000 лв.</div>
